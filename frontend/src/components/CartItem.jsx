...
const CartItem = ({item}) => {
    const { removedFromCart, updateQuantity } = useCartStore()
    return (
            ...
            <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                ...
                <div className="flex items-center justify-between md:order-3 md:justify-end">
                    <div className="flex items-center gap-2">
                        ...
                        <p>{item.quantity}</p>
                        <button
                            className="inline-flex h-5 w-5 srink-0 items-center justify-center rounded-md border border-x-gray-600 bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-emerald-500"
                            onClick={() => updateQuantity(item._id, item.quantity + 1)}
                        >
                ...
                <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        onClick={() => removedFromCart(item._id)}
                        >
                            <Trash/>
                        </button>
                    </div>
